...
Descrição: Crie um programa que solicita ao usuário que digite um número e verifica se ele é positivo ou negativo. Considere também o caso especial quando o número é zero. Objetivos de aprendizado: Entender operadores de comparação básicos (> e <) e implementar múltiplas condições com if/else if/else. Dica: Lembre-se de converter a entrada do usuário para um número usando funções como parseInt() ou parseFloat().
 
#2. Verificação de Número Par/Ímpar
Descrição: Desenvolva um programa que leia um número inteiro e determine se ele é par ou ímpar. Objetivos de aprendizado: Aprender a usar o operador de módulo (%) para verificar o resto da divisão por 2. Dica: Um número é par quando o resto da divisão por 2 é igual a zero (número % 2 === 0).
